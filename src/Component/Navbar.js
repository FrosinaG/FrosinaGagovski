    ...
    <div>
      <nav className="navbar bg-body-tertiary fixed-top mob-nav ">
        <div className="container-fluid navcon-Name ">
          <Link to="/" className="navbar-brand namenav">
              ...
              <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu">
                    ...
                    <li>
                      < Link to ="htmlCss"className="dropdown-item" >
                        HTML & CSS
                      </Link>
                    </li>
                    <li></li>
                    ...
                    <li>
                      <Link to="javaScript" className="dropdown-item" >
                        JAVA SCRIPT
                      </Link>
                    </li>

                    <li>
                      <Link to="reactpro" className="dropdown-item" >
                        REACT
                      </Link>
                    </li>
                  </ul>
